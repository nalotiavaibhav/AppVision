package com.example.alarmtrial.util.helper
...
import com.example.alarmtrial.broadcastReceiver.TIMER_COMPLETED_DISMISS_ACTION
import com.example.alarmtrial.broadcastReceiver.TIMER_COMPLETED_RESTART_ACTION
import com.example.alarmtrial.broadcastReceiver.TIMER_RUNNING_CANCEL_ACTION
import com.example.alarmtrial.broadcastReceiver.TIMER_RUNNING_IS_PLAYING
import com.example.alarmtrial.broadcastReceiver.TIMER_RUNNING_TIME_TEXT
import com.example.alarmtrial.broadcastReceiver.TimerBroadcastReceiver
import com.example.alarmtrial.screens.MainActivity
import com.example.alarmtrial.util.GlobalProperties.pendingIntentFlags
import com.example.alarmtrial.util.setIntentAction
...
class TimerNotificationHelper @Inject constructor(
    ...
    private val timerNotificationBroadcastReceiver = TimerBroadcastReceiver::class.java
    ...
    private fun pauseResumeIntentAction(
        ...
        val broadcastIntent =
            Intent(applicationContext, TimerBroadcastReceiver::class.java).apply {
